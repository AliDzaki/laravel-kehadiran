...
<body class="bg-sky-50">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full shadow-md shadow-sky-300  bg-white border-r border-gray-200 sm:translate-x-0 "
        aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
            ...
            <ul class="space-y-2 font-medium mt-5">
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-sky-100 hover:border hover:border-sky-900   group">
                        <img width="30" height="30" src="{{ asset('img/attendance.png') }}"
                            alt="attendance-mark" />
                        <span class="ms-3">Data Kehadiran</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-sky-100  group">
                        <img width="30" height="30" src="{{ asset('img/students.png') }}"
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-sky-100  group">
                        <img width="30" height="30" src="{{ asset('img/acounts.png') }}"
                            alt="external-attendance-human-resources-flaticons-lineal-color-flat-icons-2" />
